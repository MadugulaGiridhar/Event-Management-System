...
<div id="wrapper">
	<br><br>
	<form action="{{URL::to('/register_Event')}}" method="POST">
	 @csrf
    <h1 class="Eventh1">EVENT REGISTRATION</h1>
    <div class="Eventdiv">
    <p class="eventParagraph">Please fill in this form to register for the event.</p>
    <!-- <hr> -->
    ...
    <label for="YourName"><b class="eventLabel">Your Name</b></label class="eventLabel">
    <br>
    <input type="text" placeholder="Enter Your Name" name="YourName" class="eventInput" required>
    <br>
    ...
    <br>
    <label for="email"><b class="eventLabel">Email</b></label class="eventLabel">
    <br>
    <input type="text" placeholder="Enter Email" name="email" class="eventInput" required>
    <br><br>

	<input type="submit"  name="email22"  value="Register" class="eventRegister">
    </div>
