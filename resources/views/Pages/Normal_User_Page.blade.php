...
<div class="admindivision">
	...
	<div class="admincentered1"><strong>user!</strong></div>			
	</div>	

<br><br>

<h1 class="adminh1">Welcome to this website, here's what you can do.</h1>

<ul class="adminunorder">
	<li class="adminList"><a href="{{ url('/View_Profile') }}" class="adminref">View Profile</a></li>	
	<li class="adminList"><a href="{{ url('/Register_Event') }}" class="adminref">Register for an Upcoming Event</a></li>	
	<li class="adminList"><a href="#" class="adminref">View Blog</a></li>
