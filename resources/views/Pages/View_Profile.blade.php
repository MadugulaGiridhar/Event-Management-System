...
<body >
	...
	<div class="admincentered"><strong>User</strong></div>
	<div class="admincentered1"><strong>Profile</strong></div>			
	</div>	
<br>

	<h1 id="adminh2">DETAILS</h1>		
	<table class="adminTable">
		<tr class="adminRow">
			<td class="adminData">NAME</td>
			<td class="adminData">Name Populated from DB</td>

		</tr>		
		<tr class="adminRow">
			<td class="adminData">EMAIL</td>
			<td class="adminData">Email Populated from DB</td>
		</tr>
		<tr class="adminRow">
			<td class="adminData">PHONE</td>	
			<td class="adminData">Phone Populated from DB</td>			
		</tr>
		<tr class="adminRow">
			<td class="adminData">ADDRESS</td>
			<td class="adminData">Address populated from DB</td>
		</tr>
